              ...
              <CardHeader>
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-4">
                    ...
                    <CardTitle>Eventos Excluídos</CardTitle>
                  </div>
                </div>
              </CardHeader>
              <CardContent>
                                ...
                                <AlertDialogContent>
                                  <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                      Tem certeza que deseja recuperar o evento &quot;{evento.nome}&quot;? 
                        ...
                        {currentEventos.length === 0 && (
                          <TableRow>
                            <TableCell colSpan={6} className="text-center py-8 text-muted-foreground">
                              {searchTerm ? "Nenhum evento encontrado" : "Nenhum registro excluído"}
                            </TableCell>
                          </TableRow>
                        )}
                      </TableBody>
...
export default EventosExcluidos;