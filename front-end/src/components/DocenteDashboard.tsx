      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Visão geral dos seus orientandos
          </p>
        </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs opacity-80 mt-1">
                        {data.researchDefinitionsPercentages.problem}% dos orientandos preencheram
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-lg border p-3 text-warning bg-warning/10 border-warning/20">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs opacity-80 mt-1">
                        {data.researchDefinitionsPercentages.question}% dos orientandos preencheram
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-lg border p-3 text-primary bg-primary/10 border-primary/20">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs opacity-80 mt-1">
                        {data.researchDefinitionsPercentages.objectives}% dos orientandos preencheram
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-lg border p-3 text-success bg-success/10 border-success/20">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs opacity-80 mt-1">
                        {data.researchDefinitionsPercentages.methodology}% dos orientandos preencheram
                      </p>
                    </div>
                  </div>
                </div>
              ...
              {topProfessors.map((prof, index) => (
                <div key={prof.name} className="flex items-center gap-2">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-muted-foreground">{prof.students}</p>
                  </div>
                </div>
              ))}
            </div>
